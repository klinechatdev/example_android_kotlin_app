...
import com.klinechat.klinechatwebrtcexample.databinding.ItemContactBinding
import com.squareup.picasso.Picasso

class ContactAdapter : RecyclerView.Adapter<ContactAdapter.TodoViewHolder>() {

        inner class TodoViewHolder(val binding: ItemContactBinding) : RecyclerView.ViewHolder(binding.root)
        ...
        override fun onCreateViewHolder( parent: ViewGroup, viewType: Int): TodoViewHolder {
            ...
            return TodoViewHolder(ItemContactBinding.inflate(
